...
import { Trophy, Swords, Target, Hash, User, Mail, Star } from "lucide-react";
        ...
        <div className="px-8 pb-8 relative">
          ...
          <div className="mt-12 mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <div className="bg-zinc-800/50 px-6 py-3 rounded-2xl border border-zinc-700/50 flex items-center gap-3 relative -top-7">
              ...
              <div>
                <p className="text-xs text-zinc-400 uppercase tracking-wider font-semibold">Rating</p>
...
const StatCard = ({ icon, label, value, valueClass = "", hoverClass = "" }) => (
  <div className={`bg-zinc-800/40 border border-zinc-800/80 rounded-2xl p-5 flex flex-col items-center justify-center transition-all duration-300 transform hover:-translate-y-1 ${hoverClass}`}>
